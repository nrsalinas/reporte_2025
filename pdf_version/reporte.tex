...
\section*{Artropofauna en Bogota, D. C.}

\noindent \textbf{\large Esteban Tulande}
...
\begin{figure}[b]
\centering
\includegraphics[height=0.8\textheight]{6_artropofauna/fig_1.png}
\caption{Diversidad de artrópodos en las localidades de Bogotá.}
\label{6_artropofauna_fig_1}
\end{figure}
